...
{faqs_html}
        ...
        <aside>
          <div id="dlBox" class="template-page__download">
            ...
            <p>Enter your email to get the template (.txt). Editable in Word, Google Docs, or any text editor.</p>
          ...
          <div id="dlSuccess" style="display:none;" class="template-page__success">
            ...
            <a class="dl-btn" id="dlDirect" href="/templates/_files/{esc(t['slug'])}.txt" download>Download {esc(t['slug'])}.txt</a>
          </div>
        </aside>
      </div>
